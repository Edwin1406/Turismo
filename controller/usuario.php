	...
	case 'verificar':
		...
		if (isset($fetch))
	    {
			...
			//Determinamos los accesos del usuario
				...
				in_array(2,$valores)?$_SESSION['ficha']=1:$_SESSION['ficha']=0;
				in_array(3,$valores)?$_SESSION['vistas']=1:$_SESSION['vistas']=0;
				in_array(4,$valores)?$_SESSION['graficas']=1:$_SESSION['graficas']=0;
